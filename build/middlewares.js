...
exports.verifyToken = exports.authenticateToken = exports.auth = void 0;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 6:
            _context2.next = 8;
            return _jsonwebtoken["default"].verify(token, process.env.SESSION_SECRET, /*#__PURE__*/function () {
              var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(error, decoded) {
                    ...
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        return _context.abrupt("return", res.status(500).json({
                          error: "token을 decoded하는데 실패했습니다."
                        }));
                      case 2:
                        _context.next = 4;
